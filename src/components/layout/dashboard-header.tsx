...
export function DashboardHeader({
  ...
  const storeName = profile.store?.name ?? "Sem loja";
    ...
    <header className="sticky top-0 z-30 w-full border-b border-[#e8eaed] bg-white/95 backdrop-blur">
      <div className="flex min-h-[72px] min-w-0 items-center justify-between gap-2 px-3 sm:px-5 lg:min-h-[94px] lg:px-7">
        ...
        <div className="flex shrink-0 items-center gap-1 sm:gap-3">
          <button
            type="button"
            className="hidden h-11 min-w-[180px] items-center gap-3 rounded-xl border border-[#e4e6e9] bg-white px-4 text-sm font-medium text-[#353b44] shadow-sm md:flex"
          >
            ...
            <ChevronDown className="h-4 w-4 shrink-0 text-[#7a818b]" />
          </button>
